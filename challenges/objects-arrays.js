...
*/
const displayNames = [];
zooAnimals.forEach(animal => displayNames.push(`${animal.animal_name}, Scientific: ${animal.scientific_name}`));
...
*/
let animal = zooAnimals.map(animal => animal.population);

const populationTotal = animal.reduce((total, pop) => total += pop);
